...
module.exports = {
    async up(queryInterface, Sequelize) {
        queryInterface.addConstraint('carousel_reactionlists', { fields: ['carousel_ID'], type: 'foreign key', name: 'fk_carousel_reactionlist_carousel', references: { table: 'carousels', field: 'ID' } });
