...
router.route("/tag/:ID")
    ...
    .delete(tagValidator.checkIfTagIDDoesNotExsits,tagValidator,tagController.deleteTag);
...
//create new tag
router.post("/tag",tagValidator.tagRules(),commonValidator.validate,checkIfTagNameAlreadyExsits,tagController.deleteTag);
