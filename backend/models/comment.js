...
module.exports = (sequelize, DataTypes) => {
  class comment extends Model {
    ...
    static associate(models) {
      ...
      this.belongsToMany(models.reaction, { through: models.comment_reactionlist, foreignKey: "comment_ID", sourceKey: "ID" });
      this.hasMany(models.comment_reactionlist, { foreignKey: 'comment_ID', sourceKey: 'ID' });
    }
  };
  comment.init({
